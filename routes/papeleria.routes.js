...
mongoose.connect(process.env.MONGO_URI)
   ...
   router.put('/editar-plan-abonos', editPaymentPlan);

   // Rutas para códigos aleatorios
   router.post('/generate-code', generateCodeAfterLogin);
   router.post('/validate-code', validateCodeEndpoint);
   router.post('/cleanup-codes', cleanupCodesEndpoint);
   
   // Rutas para envío de OTP por email
   router.post('/send-otp-email', generateAndSendOTPEndpoint);
   
   // Rutas para envío de credenciales por email
   router.post('/send-credentials-email', sendCredentialsByEmailWrapper);
   
   // Rutas para verificación de OTP
